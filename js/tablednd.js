...
document.onmousemove = function(ev){
    if (currenttable && currenttable.dragObject) {
        ...
        if (y != currenttable.oldY) {
            ...
            //currenttable.dragObject.style.backgroundColor = "#00F";
            CSSClass.add(currenttable.dragObject,'selected_row');
...
document.onmouseup   = function(ev){
    if (currenttable && currenttable.dragObject) {
        ...
        CSSClass.remove(currenttable.dragObject,'selected_row')
...
function TableDnD() {
    ...
    this.makeDraggable = function(item) {
        ...
        item.onmousedown = function(ev) {
            ...
            CSSClass.add(item,'selected_row');
            return false;
        }
